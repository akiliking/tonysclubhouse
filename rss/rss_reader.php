...
//$file = "http://rss.news.yahoo.com/rss/topstories";//"http://slashdot.org/index.rss";
...
// output as HTML
print ("<html><head><title>Clubhouse RSS Reader</title></head><body>");
...
if (isset($rss_channel["ITEMS"])) {
	if (count($rss_channel["ITEMS"]) > 0) {
		for($i = 0;$i < count($rss_channel["ITEMS"]);$i++) {
			print ("\n<table class=\"newstable\" width=\"85%\" border=\"0\"><tr><td width=\"100%\"><a href=\"" . $rss_channel["ITEMS"][$i]["LINK"] . "\" target=\"_blank\"><h4>" . $rss_channel["ITEMS"][$i]["TITLE"] . "</h4></a></b>");
