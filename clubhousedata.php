...
<?php
  ...
  if ($RequestType == "addWebData"){
	...
	$page = "http://www.kingplus.com/IAPPP/php/main.php&categoryId=".$CategoryId."&type=".$datatype;
  	//$result = $GETWEBDATA-> addClubhouseEvent($CategoryId, $datatype, $title, $active, $summary, $detail,$author, $userfile, $urllink) 
  	$result = $GETWEBDATA-> addClubhouseEvent($CategoryId, $title, $active, $summary, $detail, $location, $url, $active, $start_date, $end_date, $userfile,$urllink)  . "<br/>";
