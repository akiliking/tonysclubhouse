		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%">
		  <tr>
		    <td width="100%" valign="top" align="left" colspan="2">
		      <p align="center"><b><font color="#223E4C" size="5"><b>More House Videos</b></font><font color="#CCD3B6"></p>
		      <p align="center"><b>[ <a href="index.html">Home</a> | <a href="history.html">History of House</a> |  <a href="store.html">Merchandise</a> |
		      	<a href="music.php">24/7 House Music</a> | <a href="featured.html">ClubHouse Featured</a> | <a href="events.php">Events Page</a>]
			  </p>
			  <hr>
			</td>
		  <tr>
...
$sql_select = 	"SELECT title,video_code FROM tblVideos where active = 1 ORDER BY RAND() LIMIT 10";
...
$numshows= mysql_num_rows($show_result);
 if ($numshows > 0) {
	while($event = mysql_fetch_assoc($show_result)) {
		...
		echo "<p><div>" .$event['title'] ."</div></p>";
		echo "<p><div>" .$event['video_code'] ."</div></p>";
