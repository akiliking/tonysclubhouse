...
<html>
	...
	<head>
		...
		<LINK href="css/style.css" type="text/css" rel="STYLESHEET"><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
		...
		<meta name="keywords" content="ring tones, Music, Urban, House, R&B,CD,MP3,dance,WLFR,Turn table,ipod,TCS,TCATS, dance, silena murrell, Numark,technics,radio,mp3,Music, House, Club, WLFR, WNYU, DJ Tony Ton, Akili,Tón,kingplus.com,kingplus, Gospel,Napster,djtonyton, Deep House"> 
...
<table cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
    ...
    <td width="80%" rowSpan="2" vAlign="top" bgColor="black" style="left-padding=5px;"> 
      <div id="displaypage" align="center" > 
        <?php
        	if($page){
				$findme = "HTTP";
    ...
    <td vAlign="top" rowSpan="2"> 
     ...
     /*
		...
		?>     
								...
								<br>
<?php include "mixes.php";
include "promo/index.html";?></div>
  ...
  src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
      ...
      <div class="navFooter" align="center" > 
        ...
        <div style="FONT-SIZE: 10px; PADDING-TOP: 5px" align="center">Copyright 
          ©2006 All Rights Reserved.</div>      </div></td>
  </tr>
</table>
<p>&nbsp;</p></body>
